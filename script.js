...
Moralis.initialize('xlSnPvPya2Zuj9XUM8hPHUBRM4qk6YJNgZLw3AG6');
//Server url from moralis.io
Moralis.serverURL = 'https://qkd7a5upiaro.moralishost.com:2053/server';
...
async function testCall() {
  try {
    result = await web3.eth.personal.sign('Hello human', user.get('ethAddress'));
  } catch (error) {
